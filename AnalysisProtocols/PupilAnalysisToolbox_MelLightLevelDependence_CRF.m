...
basePath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_data/MelLightLevelDependence5sMelanopsinDirectedPenumbralIgnoreNegativePulseConeNoiseCRF_ND10'];
resultsPath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_analysis/MelLightLevelDependence5sCRF_ND10'];
...
basePath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_data/MelLightLevelDependence5sMelanopsinDirectedPenumbralIgnorePositivePulseConeNoiseCRF_ND10'];
resultsPath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_analysis/MelLightLevelDependence5sCRF_ND10'];
...
basePath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_data/MelLightLevelDependence5sLMSDirectedNegativePulseConeNoiseCRF_ND10'];
resultsPath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_analysis/MelLightLevelDependence5sCRF_ND10'];
...
basePath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_data/MelLightLevelDependence5sLMSDirectedPositivePulseConeNoiseCRF_ND10'];
resultsPath = ['/Users/' userID '/Dropbox (Aguirre-Brainard Lab)/MELA_analysis/MelLightLevelDependence5sCRF_ND10'];
