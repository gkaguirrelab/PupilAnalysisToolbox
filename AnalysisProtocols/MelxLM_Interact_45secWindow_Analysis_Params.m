...
Protocols={'PupillometryLMConeMelInteraction'};
...
oldLabels = {'Modulation-LMDirectedHighMel-45sWindowedFrequencyModulation-20','Modulation-LMDirectedLowMel-45sWindowedFrequencyModulation-20'};
newLabels = {'L+M_HighMel','L+M_LowMel'};

ResultsDirName = 'Mel_x_LM_Interaction';
