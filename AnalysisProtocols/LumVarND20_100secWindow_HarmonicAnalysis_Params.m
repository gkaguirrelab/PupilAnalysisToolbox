...
HarmonicTestFlag=1; % If set, generate all response plots assuming harmonic stimulation
...
spike_remover_params(2)=0.10; % The max acceptable proportion change in the window
...
Protocols={'LumVarND20_protocolA_Peri_Dilate_5mmPinhole',...
    'LumVarND20_protocolB_Peri_Dilate_5mmPinhole'};
...
newLabels = {'S_r' ; 'Mel' ; 'LM'};
oldLabels = {'LumVar_ND20-SIsolatingRobust' ; 'LumVar_ND20-MelanopsinDirected' ;...
    'LumVar_ND20-LMDirected' };

ResultsDirName = 'LumVarND20_100secWindow_Harmonic';
