...
% Note as well: If the HarmonicTestFlag is set, the results directory
% should include "Harmonic" in its name
...
Protocols={'RISC_Peri_Dilate_5mmPinhole'};
...
newLabels = {'Mel' ; 'S' ; 'S_r'};
oldLabels = {'RISC-MelanopsinDirected' ; 'RISC-SIsolating' ;...
    'RISC-SIsolatingRobust' };


ResultsDirName = 'RISC_100secWindow_Harmonic';
