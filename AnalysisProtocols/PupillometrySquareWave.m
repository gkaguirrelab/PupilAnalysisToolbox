...
HarmonicModelFlag=0; % If set, model in the sparkline plots the harmonic
...
full_trial_length = 312;  % The length in seconds of the full trial
%   acquisition
final_trial_length = 312; % The length of each data trial after processing,
...
spike_remover_params(2)=1; % The max acceptable proportion change in the window
spike_remover_params(3)=10; % The max acceptable change in SD units in the window
...
Protocols={'PupillometryNulledSqWave'};
...
newLabels = {'Iso', 'LMS', 'Mel'};

oldLabels = {'Modulation-Isochromatic-312sSquareWaveModulation-44', 'Modulation-LMSDirected-312sSquareWaveModulation-44', 'Modulation-MelanopsinDirectedLegacy-312sSquareWaveModulation-44'};


ResultsDirName = 'PupillometryLuxotonic';
