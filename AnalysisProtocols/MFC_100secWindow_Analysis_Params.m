...
BadPercentChangeThreshold = 0.40;       % Any time point with an absolute change from
% the mean of greater than this proportion will be NaN-ed, as it is
% certainly noise
BadNanThreshold = 0.20; % If more than this proportion
...
Protocols={'MFC'};
% configFileNames = {'MFC-LMDirectedFoveal-OLEyeTrackerLongCable.cfg' ; ...
%     'MFC-MelanopsinDirectedFoveal-OLEyeTrackerLongCable.cfg' ; ...
%     'MFC-SIsolatingFoveal-OLEyeTrackerLongCable.cfg'};
...
newLabels = {'LM' ; 'Mel' ; 'S'};
oldLabels = {'MFC-LMDirectedFoveal' ; 'MFC-MelanopsinDirectedFoveal' ;...
    'MFC-SIsolatingFoveal' };

ResultsDirName = 'MFC_100secWindow';
