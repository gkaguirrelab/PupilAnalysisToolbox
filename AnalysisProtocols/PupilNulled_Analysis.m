...
Subjects = {'G081815A' 'M081815S' 'M081915M'};

RelabelSubjectsFlag=0;

Protocols={'PupilNulled0_1Hz'};
...
newLabels = {'LMSDirected', 'MelanopsinDirectedLegacy'};

oldLabels = {'LMSDirected', 'MelanopsinDirectedLegacy'};

ResultsDirName = 'PupilNulled0_1Hz';
