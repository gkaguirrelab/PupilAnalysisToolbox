...
oldLabels = {'LMDirected' ; 'SDirected' ;...
    'MelanopsinDirected' ; 'MelanopsinDirectedLegacy' };
newLabels = {'LM' ; 'S_r' ; 'Mel' ; 'Mel'};

ResultsDirName = 'TTF4Dxc_45sWindow_005Hz';
