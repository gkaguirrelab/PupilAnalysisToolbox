...
oldLabels = {'LMSDirectedNulledPositive_CRF_09pct', 'LMSDirectedNulledPositive_CRF_18pct', 'LMSDirectedNulledPositive_CRF_36pct'};    

ResultsDirName = 'MelLightLevelDependence5sLMSDirectedPositivePulseConeNoiseCRF_ND10';
