...
full_trial_length = 50;  % The length in seconds of the full trial
%   acquisition
final_trial_length = 45; % The length of each data trial after processing,
%   taken from the tail of each full data trial.
%    That is, we discard some data from the start of each trial.
minimum_length_trial=47; % Any trial shorter than this will be discarded
...
spike_remover_params(2)=0.5; % The max acceptable proportion change in the window
spike_remover_params(3)=4; % The max acceptable change in SD units in the window
sgolay_span = 5;         % Parameters of the SGolay interpolation prior
sgolay_polynomial = 4;    %   to interpolation
...
% certainly noise
BadNanThreshold=0.1; % If more than this proportion
...
Subjects = {'J100715RxND10' 'M100915SxND10' 'G100815AxND10'};
%Subjects = {'M100915SxND10'};
RelabelSubjectsFlag=0;

Protocols={'MelLightLevelDependence5sLMSMelanopsinDirectedPenumbralIgnoreDoublePulse_ND10'};
...
newLabels = {'LMS-_18pct_Mel_-36pct', 'LMS-_18pct_Mel_00pct', 'LMS-_18pct_Mel_+36pct', ...
    'LMS+_18pct_Mel_-36pct', 'LMS+_18pct_Mel_00pct', 'LMS+_18pct_Mel_+36pct'};
oldLabels = {'LMSMelanopsinDirectedPenumbralIgnoreNegativeStepDoublePulse_DoublePulse_-36pct', ...
    'LMSMelanopsinDirectedPenumbralIgnoreNegativeStepDoublePulse_DoublePulse_00pct', ...
    'LMSMelanopsinDirectedPenumbralIgnoreNegativeStepDoublePulse_DoublePulse_36pct' ...
    'LMSMelanopsinDirectedPenumbralIgnorePositiveStepDoublePulse_DoublePulse_-36pct', ...
    'LMSMelanopsinDirectedPenumbralIgnorePositiveStepDoublePulse_DoublePulse_00pct', ...
    'LMSMelanopsinDirectedPenumbralIgnorePositiveStepDoublePulse_DoublePulse_36pct'};    

ResultsDirName = 'MelLightLevelDependence5sLMSMelanopsinDirectedPenumbralIgnoreDoublePulse_ND10';

[TimeSeries]=PulseSequentialTrialAnalysis(...
    sampling_frequency,...
    full_trial_length,...
    final_trial_length,...
