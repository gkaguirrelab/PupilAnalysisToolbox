...
minimum_length_trial=45; % Any trial shorter than this will be discarded
...
Subjects = {'G092415AxND03'};

RelabelSubjectsFlag=0;

Protocols={'MelLightLevelDependence5sPulse_ND03'};
...
oldLabels = {'LMSDirectedNulledNegative', 'LMSDirectedNulledPositive', 'MelanopsinDirectedPenumbralIgnoreNulledNegative', 'MelanopsinDirectedPenumbralIgnoreNulledPositive'};
    
ResultsDirName = 'MelLightLevelDependence5sPulse_ND03';
