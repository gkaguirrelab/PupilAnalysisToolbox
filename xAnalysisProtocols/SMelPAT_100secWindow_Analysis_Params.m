...
Protocols={'SMelPAT_Inphase_Peri_Dilate_5mmPinhole','SMelPAT_Outphase_Peri_Dilate_5mmPinhole'};
%configFileNames = {'SMelPAT-MelSInPhase-OLEyeTrackerLongCable.cfg' ; ...
%    'SMelPAT-MelSOutPhase-OLEyeTrackerLongCable.cfg'};
configFileNames=[];
...
newLabels = {'S/Mel-IN' ; 'S/Mel-OUT' };
oldLabels = {'SMelPAT-MelSInPhase' ; 'SMelPAT-MelSOutPhase' };


ResultsDirName = 'SMelPAT_100secWindow';
